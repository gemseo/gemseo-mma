...
The developers thank all the open source libraries making GEMSEO-mma possible.

External Dependencies
---------------------

GEMSEO-mma depends on software with compatible licenses that are listed below.
